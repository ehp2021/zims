        ...
        <GridItem marginTop={'20px'} borderRadius={'30px'} colSpan={2} bg="gray">
          ...
          <div className="button-container" style={{display:"flex", flexDirection: "row", marginLeft:"10px"}}>
            <div className="button-left" style={{display:"flex", flexDirection: "column", marginLeft:"10px"}}>
              <button className="work-button" style={{marginBottom: "10px", width: "150px",border: "1px solid black", borderRadius: "90px"}}>WORK</button>
              <button className="workout-button" style={{marginBottom: "10px", width: "150px", border: "1px solid black", borderRadius: "90px"}}>WORK OUT</button>
              <button className="workout-button" style={{marginBottom: "10px", width: "150px", border: "1px solid black", borderRadius: "90px"}}>MEDITATE</button>
            </div>
            <div className="button-right" style={{display:"flex", flexDirection: "column", marginLeft:"10px"}}>
              <button className="work-button" style={{marginBottom: "10px", width: "150px",border: "1px solid black", borderRadius: "90px"}}>VOLUNTEER</button>
              <button className="workout-button" style={{marginBottom: "10px", width: "150px", border: "1px solid black", borderRadius: "90px"}}>PARTY</button>
              <button className="workout-button" style={{marginBottom: "10px", width: "150px", border: "1px solid black", borderRadius: "90px"}}>SHOWER</button>
